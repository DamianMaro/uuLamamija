...
const Errors = require("../api/errors/lamamija-main-error.js");
...
const logger = LoggerFactory.get("LamamijaMainAbl");

class LamamijaMainAbl {
  constructor() {
...
module.exports = new LamamijaMainAbl();
